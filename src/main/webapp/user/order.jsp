...
<!--文件体开始-->
        ...
        <c:forEach items="${AllOrder}" var="order" varStatus="status">
		<tr>
			<td class=tablebody2 valign=middle align=center width="">${status.count}</td>
			<td class=tablebody1 valign=middle width=""   style="text-align: center;">&nbsp;&nbsp;<a href="">${order.id}</a></td>
			<td class=tablebody2 valign=middle align=left width=""  style="text-align: center;">&nbsp;&nbsp;${order.cost}</td>
			<td class=tablebody1 valign=middle align=center width="">处理中</td>
			<td class=tablebody2 valign=middle align=left width=""  style="text-align: center;">&nbsp;&nbsp;货到付款 </td>
