...
<head>
	...
	<meta name="description" content="FamilyCart电子商务门户">
	<title>电子商务门户</title>
	    ...
	    <td background="images/dh_bg.gif" align="left" height="12">
	      <table width="100" border="0" cellspacing="0" cellpadding="0" align="center">
	        <tr>
	          ...
	          <td width="10%"><a href="user/logout" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','images/exit_on.gif',1)">
